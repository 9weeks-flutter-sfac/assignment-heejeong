...
import 'package:test/2_secret_page/secret_detail.dart';
...
class _SecretPageState extends State<SecretPage> {
  ...
  //다이얼로그 버튼 핸들링
  _onChangedSecret(
      String conceptTitle, String conceptSubtitle, String conceptThumbUrl) {
    concepts.add({
                    ...
                    ElevatedButton(
                        onPressed: () {
                          _onChangedSecret(
                              ...
                              thumbUrlTextEditingController
                                  .text); // 버튼을 눌렀을 때 함수 실행
                          //텍스트필드의 텍스트 초기화
                          titleTextEditingController.text = '';
                          subtitleTextEditingController.text = '';
                  ...
                  return InkWell(
                      onTap: () => Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => SecretDetail(
                                ...
                                backgroundImageUrl: concepts[index]
                                    ['thumbnail']!,
                              ))),
                      //애니메이션넣기
                      child: FadeInRight(
                        ...
                        leading: CircleAvatar(
                          backgroundImage:
                              NetworkImage(concepts[index]['thumbnail']!),
                        ),
