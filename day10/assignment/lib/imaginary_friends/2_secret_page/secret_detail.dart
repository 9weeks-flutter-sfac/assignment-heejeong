...
import 'package:assignment/imaginary_friends/3_secret_upload/secret_upload.dart';
...
class _SecretDetailState extends State<SecretDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.secretTitle, style: TextStyle(color: Colors.amber),),
        centerTitle: true,
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(image: NetworkImage(widget.backgroundImageUrl),
            opacity: 0.3,
            fit: BoxFit.cover
          )
        ),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          leading: author?.avatar != null
                              ...
                              : CircleAvatar(
                                  child: Image.network(avatarList[0],),
                                ),
                          title: Text(secret),
