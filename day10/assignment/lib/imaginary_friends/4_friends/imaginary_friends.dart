...
class _ImaginaryFriendsState extends State<ImaginaryFriends> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('상상 친구들', style: TextStyle(color: Colors.amber[800]),),
        centerTitle: true,
                        ...
                        return Column(
                          ...
                          children: [
                            ...
                            author?.username != null
                              ? Text(author!.username, style: TextStyle(color: Colors.white),)
